 ...
 * @author DELL
 */
public class ListAllTutor extends javax.swing.JPanel {
    ...
    private void AddRowToJTable()
    {
        ...
        Tutor ad = new Tutor();
        ArrayList<Tutor> tutors = ad.ListAllTutor();
        for(Tutor a : tutors){
            rowData[0]=a.getID();
            rowData[1]=a.getName();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Pass", "Tel", "Department", "Office Hour", "Salary"
            }
        ) {
