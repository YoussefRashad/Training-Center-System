 ...
 * @author DELL
 */
public class SearchTutor extends javax.swing.JPanel {

    /**
     * Creates new form SearchTutor
     */
    ...
    private void initComponents() {
        ...
        jTextFieldIDTutorSearch = new javax.swing.JTextField();
        ...
        jLabelSuccessOrFail.setText("Search For Tutor ... !");
        ...
        jTextFieldIDTutorSearch.setFont(new java.awt.Font("Monotype Corsiva", 0, 20)); // NOI18N
        jTextFieldIDTutorSearch.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextFieldIDTutorSearch.setBorder(null);
        jTextFieldIDTutorSearch.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldIDTutorSearchActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                .addComponent(jTextFieldTel, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    ...
                                    .addComponent(jTextFieldSalary, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(jComboBoxDeprt, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(30, 30, 30)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jComboBoxOfficeH, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(145, 145, 145)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(jTextFieldIDTutorSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                .addGap(67, 67, 67)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jLabelSuccessOrFail, javax.swing.GroupLayout.PREFERRED_SIZE, 457, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jTextFieldIDTutorSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jComboBoxDeprt, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jPanelDelete, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void setPanel(Tutor x)
     {
        ...
        jComboBoxDeprt.setSelectedItem(x.getDepart());
        jComboBoxOfficeH.setSelectedIndex(x.getOfficeHours()-1);
        jTextFieldSalary.setText(""+x.getSalary());
     }
     private void resetPanel()
     {
        jTextFieldIDTutorSearch.setText("");
        jTextFieldEmail.setText("");
        jTextFieldID.setText("");
        jTextFieldName.setText("");
        jTextFieldTel.setText("");
        jTextFieldPass.setText("");
        jComboBoxDeprt.setSelectedItem(0);
    ...
    private void jTextFieldIDTutorSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldIDTutorSearchActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldIDTutorSearchActionPerformed
    ...
    private void jLabel19MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel19MouseClicked
        ...
        if(!jTextFieldIDTutorSearch.getText().equals("")&&!jTextFieldEmail.getText().equals("")&&!jTextFieldID.getText().equals("")&&!jTextFieldName.getText().equals("")&&
           !jTextFieldTel.getText().equals("")&&!jTextFieldPass.getText().equals("")&&!jTextFieldSalary.getText().equals(""))
        {
            Validation v = new Validation();
            if(v.checkID(jTextFieldIDTutorSearch.getText())){
                ...
                if(v.checkName(jTextFieldName.getText())){
                                ...
                                if(v.checkEmail(jTextFieldEmail.getText())){
                                    if(v.checkPhoneNo(jTextFieldTel.getText())){
                                        if(v.checkSalary(jTextFieldSalary.getText())){
                                            ...
                                            Tutor ad = new Tutor();
                                            if(!jTextFieldID.getText().equals(jTextFieldIDTutorSearch.getText())){
                                                ...
                                                ad.setEmail(jTextFieldEmail.getText());
                                                    ...
                                                    ad.setDepart(jComboBoxDeprt.getSelectedItem().toString());
                                                    ad.setOfficeHours((jComboBoxOfficeH.getSelectedIndex()+1));
                                                    ad.setSalary(Double.parseDouble(jTextFieldSalary.getText()));
                                                        if(ad.editTutor(Integer.parseInt(jTextFieldIDTutorSearch.getText()))){
                                                            jLabelSuccessOrFail.setText("Updated Successfully ...! :)");
                                                            resetPanel();
                                                        }
                                                        else{
                                                        jLabelSuccessOrFail.setText("Failed Updated ...! :(");
                                                        JOptionPane.showMessageDialog(null, "Not Found ID Tutor ,Failed Update...!\n Try Again :(");
                                                        resetPanel();
                                                        }
                                                    }
                                                else{
                    ...
                    JOptionPane.showMessageDialog(null, "Not valid ID Tutor Try Again :(\nHint: ID Tutor Length should more than 4 .. ;)");
                    jPanelWrongID.setVisible(true);
                }
            
                }
            else{
                JOptionPane.showMessageDialog(null, "Not valid Search Key Try Again :(\nHint: Search Key by ID Length should more than 4 .. ;)");
    ...
    private void jLabel20MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel20MouseClicked
        ...
        if(!jTextFieldIDTutorSearch.getText().equals(""))
        {
            if(new Validation().checkID(jTextFieldIDTutorSearch.getText())){
                Tutor ad = new Tutor();
                if(ad.removeTutor(Integer.parseInt(jTextFieldIDTutorSearch.getText()))){
                    resetPanel();
            ...
            jLabelSuccessOrFail.setText("Missing Required ID Tutor ... !  Please, complete it before submit ...! :(");
    ...
    private void jLabelSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelSearchMouseClicked
        ...
        if(!jTextFieldIDTutorSearch.getText().equals("")){
            if(new Validation().checkID(jTextFieldIDTutorSearch.getText())){
                Tutor x = new Tutor();
                x=x.getTutor(Integer.parseInt(jTextFieldIDTutorSearch.getText()));
                if(x!=null){
                    setPanel(x);
    ...
    private javax.swing.JTextField jTextFieldIDTutorSearch;
